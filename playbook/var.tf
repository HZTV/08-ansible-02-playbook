...
variable "each_vm" {
  type = list(object({  
    ...
    default = [ {vm_name = "clickhouse", cpu = 2, ram = 4, disk_volume = 20, core_fraction = 20, type_storage="network-hdd", preemptible = false, nat= true },
                {vm_name = "vector", "cpu" = 2, ram = 4, disk_volume = 20, core_fraction = 20, type_storage="network-hdd", preemptible = true, nat= true }
     ]
}